...
(function (root, factory) {
    ...
    function _initializeZoom() {
        var self = this,
            ...
            minus = self.elements.zoomerPlus = document.createElement('a'),
            plus = self.elements.zoomerPlus = document.createElement('a'),
            zoomer = self.elements.zoomer = document.createElement('input');

        addClass(wrap, 'cr-slider-wrap');
        addClass(minus, 'cr-slider-minus');
        addClass(plus, 'cr-slider-plus');
        ...
        var plusTimer, minusTimer;

        plus.addEventListener('mousedown', function () {
            zoomin();

            function zoomin () {
                 targetZoom = self._currentZoom + 0.1;

                _setZoomerVal.call(self, targetZoom);
                change();

                plusTimer = setTimeout(zoomin, 100);
            }
        });
        minus.addEventListener('mousedown', function () {
            ...
            function zoomout () {
                ...
                minusTimer = setTimeout(zoomout, 100);
            }
        });
